...
##После клонирования репозитория, в корне создайте файл .env и добавьте туда (СВОЙ) API-KEY , чтобы это выглядело примерно так REACT_APP_MY_API_KEY=ВАШ_API-KEY
и REACT_APP_URL=https://www.googleapis.com/books/v1/
