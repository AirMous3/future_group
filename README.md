...
1. Фильтрация по категориям. Ниже текстового поля располагается селект с категориями: all, art, biography, computers, history, medical, poetry. Если выбрано "all" (выбрано изначально), то поиск производится по всем категориям.
...
## После клонирования репозитория, в корне создайте файл .env и добавьте туда API-KEY , чтобы это выглядело так REACT_APP_MY_API_KEY=AIzaSyBLQbTDxcZy3nUi3j1-Z5lIA_zd8i_dWQA и REACT_APP_URL=https://www.googleapis.com/books/v1/
